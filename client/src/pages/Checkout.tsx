...
Please contact the customer with payment instructions.
      `.trim();

      // Create mailto link
      const mailtoLink = `mailto:sales@iptvlion.shop?subject=New Lion TV Order from ${formData.customerName}&body=${encodeURIComponent(emailBody)}`;
        ...
        <div className="container max-w-2xl">
          <div className="text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Thank you for your order. We've sent the details to your email at <strong>{formData.customerEmail}</strong>
            </p>
